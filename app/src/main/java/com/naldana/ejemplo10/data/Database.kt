...
private const val SQL_CREATE_ENTRIES =
    "CREATE TABLE ${DatabaseContract.PersonaEntry.TABLE_NAME} (" +
            ...
            "${DatabaseContract.PersonaEntry.COLUMN_NAME} TEXT," +
            "${DatabaseContract.PersonaEntry.COLUMN_COUNTRY} TEXT," +
            "${DatabaseContract.PersonaEntry.COLUMN_VALUE} TEXT," +
            "${DatabaseContract.PersonaEntry.COLUMN_VALUE_US} TEXT," +
            "${DatabaseContract.PersonaEntry.COLUMN_YEAR} TEXT," +
            "${DatabaseContract.PersonaEntry.COLUMN_REVIEW} TEXT," +
            "${DatabaseContract.PersonaEntry.COLUMN_ISAVAILABLE} TEXT," +
            "${DatabaseContract.PersonaEntry.COLUMN_IMG} TEXT)"
...
class Database(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    ...
    /*override fun onCreate(db: SQLiteDatabase) {
        //db.delete(DatabaseContract.PersonaEntry.TABLE_NAME, null, null)
